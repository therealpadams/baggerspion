        ...
        <header className="md:flex sm:justify-between md:items-center py-6 border-black border-t-2">
            ...
            <nav className={ showMe ? "grid grid-cols-1 md:flex md:space-x-4 pt-2 md:pt-0" : "hidden md:flex md:space-x-4 pt-2 md:pt-0"}>
                ...
                <div className="flex space-x-4 pt-4 md:pt-0 md:pl-4">
                    <Link href="https://www.linkedin.com/in/pauljadams/"><a onClick={toggle} className="text-sm hover:text-orange-500"><FontAwesomeIcon icon={faLinkedinIn} /></a></Link>
                    <Link href="https://github.com/therealpadams"><a onClick={toggle} className="text-sm hover:text-orange-500"><FontAwesomeIcon icon={faGithub} /></a></Link>
                    <Link href="https://twitter.com/therealpadams"><a onClick={toggle} className="text-sm hover:text-orange-500"><FontAwesomeIcon icon={faTwitter} /></a></Link>
                    <Link href="https://www.instagram.com/therealpadams/"><a onClick={toggle} className="text-sm hover:text-orange-500"><FontAwesomeIcon icon={faInstagram} /></a></Link>
                </div>
            </nav>
        </header>
    )
