...
As of version 2.1, TailwindCSS absolutely does support arbitrary pixel values, thanks to the new [JIT mode](https://tailwindcss.com/docs/just-in-time-mode). So, instead of the clunky inline style, I can set the height oif the hero as follows:
