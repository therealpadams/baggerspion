...
export const meta = {
    ...
    description: 'Continuing my thoughts on Lehman\'s laws',
    date: '2016-12-23',
    image: 'creep.webp',
    author: {
        name: 'Paul Adams',
...
already, you should go and take a look at my introductory post [over here.](/2016/12/evolution/)
...
fast as you can?" Sadly you were (or are) trapped inside a [feature factory](https://hackernoon.com/12-signs-youre-working-in-a-feature-factory-44a5b938d6a2#.djumkhd6a). This
