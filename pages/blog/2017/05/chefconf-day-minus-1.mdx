...
export const meta = {
    ...
    description: 'Notes from the day before ChefConf in Austin.',
    date: '2017-05-22',
    image: 'chefconfheader.webp',
    author: {
        name: 'Paul Adams',
        avatar: 'paul.png',
